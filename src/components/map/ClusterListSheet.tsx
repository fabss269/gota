...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 16, fontWeight: '800', color: Colors.primaryDark },
  ...
  itemTipo: { fontSize: 13, fontWeight: '700', color: Colors.textBody },
  itemDireccion: { fontSize: 11, color: Colors.textMuted, marginTop: 2 },
  chevron: { fontSize: 18, color: Colors.textMuted, flexShrink: 0 },
});
